...
/* ---------------- Do NOT Touch END-------------- */
	...
	double exp_burst, exp_burst_prev, burst_prev;
	double rq_wait_time;					/* Time that the process is waiting in the running queue */
	double total_wait_time;					/* Total waiting time of the process (from the time it was 
											created until the time it was terminated) */
	double spawned_time;					/* When the process was created */
